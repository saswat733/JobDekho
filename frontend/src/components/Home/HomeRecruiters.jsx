...
function HomeRecruiters() {
  return (
    <div className="md:flex px-7 md:px-10 py-6 font-Poppins bg-white text-black">
      ...
      <div className="md:w-1/2">
        ...
        <img src="https://job-hunter.noobnarayan.in/assets/happyRecruiters-Qft8pceb.svg" alt="img" />
        </div>
      </div>
    </div>
  );
